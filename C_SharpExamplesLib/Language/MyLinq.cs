...
namespace C_SharpExamplesLib.Language
{
    ...
    public abstract class MyLinq
    {
        ...
        public static void Linq_Zip()
        {
            ...
            Assert.Contains("one", numbersAndWords.First());
            Assert.Contains("1", numbersAndWords.First());
        ...
        public static void Linq_OrderBy()
        {
            ...
            Assert.AreEqual(1, sortedNumbers.First().Item1);
        }
        ...
        public static void Linq_Single()
        {
            ...
            Assert.AreEqual(1, oneElementSet.Single());

            IEnumerable<int> twoElementSet = Enumerable.Range(1, 2);
            Assert.Throws<InvalidOperationException>(() => { _ = twoElementSet.Single(); });
        }
        ...
        public static void LinqChunking()
        {
            ...
            Assert.HasCount(3, e3);
            Assert.Contains(1, e3[0]);
            Assert.Contains(2, e3[0]);
            Assert.Contains(3, e3[1]);
            Assert.Contains(4, e3[1]);
            Assert.Contains(5, e3[2]);
        }
    }
}
